//
//  RBPopUpActivityPlanViewController.m
//  Brightr
//
...
@implementation RBPopUpActivityPlanViewController

+ (instancetype)controllerWithStoryBoard:(UIStoryboard *)storyboard {
    RBPopUpActivityPlanViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"RBPopUpActivityPlanViewController"];
