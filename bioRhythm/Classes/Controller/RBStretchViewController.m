...
@interface RBStretchViewController ()
...
@implementation RBStretchViewController

+ (instancetype)controllerWithStoryBoard:(UIStoryboard *)storyboard {
    RBStretchViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"RBStretchViewController"];
