//
//  RBPopUpBioPlanViewController.m
//  Brightr
//
...
@interface RBPopUpBioPlanViewController ()
...
@implementation RBPopUpBioPlanViewController

+ (instancetype)controllerWithStoryBoard:(UIStoryboard *)storyboard {
    RBPopUpBioPlanViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"RBPopUpBioPlanViewController"];
