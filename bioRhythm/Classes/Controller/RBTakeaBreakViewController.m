...
@interface RBTakeaBreakViewController ()
...
@implementation RBTakeaBreakViewController

+ (instancetype)controllerWithStoryBoard:(UIStoryboard *)storyboard {
    RBTakeaBreakViewController *controller = [storyboard instantiateViewControllerWithIdentifier:@"RBTakeaBreakViewController"];
